...
uniqueN(ebba2$cell50x50)

uniqueN(ebba1$Species)
uniqueN(ebba2$Species)
...
SR <- function(df) {
  ...
  df[, .(SR = data.table::uniqueN(Species)), by = cell50x50]
}
...
write_csv(ebba1_SR, "own datasets/SR_ebba1_50km.csv")
...
plot_SR <- function(df) {
  ...
  plot <- ggplot(plot_df) +
    ...
    theme_minimal() +
    labs(
      title = paste(deparse(substitute(df))),
      fill = "SR"
    )
...
plot
ggsave("plots/species richness/SR_birds_ebba1.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
write_csv(ebba2_SR, "own datasets/SR_ebba2_50km.csv")
...
plot
ggsave("plots/species richness/SR_birds_ebba2.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot
ggsave("plots/species richness/deltaSR_birds.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
occ_ebba1 <- occ_count(ebba1)

occ_ebba2 <- occ_count(ebba2)
...
write_csv(delta_SR_b1, "own datasets/deltaSR_birds_50km.csv")


# clear memory
rm(list = c("ebba1", "ebba2"))
gc()
...
SR_m_b2000 <- SR(m_b2000)
SR_m_a2015 <- SR(m_a2015)
...
write_csv(SR_m_b2000, "own datasets/SR_m_b2000_50km.csv")
write_csv(SR_m_a2015, "own datasets/SR_m_a2015_50km.csv")
...
plot
ggsave("plots/species richness/SR_mammals_b2000.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


plot <- plot_SR(SR_m_a2015)
plot
ggsave("plots/species richness/SR_mammals_a2015.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot
ggsave("plots/species richness/SR_mammals_b2000_reduced.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


plot <- plot_SR(SR_m_a2015_red)
plot
ggsave("plots/species richness/SR_mammals_a2015_reduced.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot
ggsave("plots/species richness/deltaSR_mammals_50km.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
occ_b2000 <- occ_count(m_b2000)
occ_a2015 <- occ_count(m_a2015)
...
write_csv(delta_SR_m1, "own datasets/deltaSR_mammals_50km.csv")



delta_SR_m_red1 <- delta_SR_m_red1[, c(
  "cell50x50",
  "occ_m_b2000", "SR_m_b2000",
  "occ_m_a2015", "SR_m_a2015",
  "delta_SR", "delta_occ_m"
...
write_csv(delta_SR_m_red1, "own datasets/deltaSR_mammals_50km.csv")


# clear memory
rm(list = c("m_b2000", "m_a2015", "SR_m_b2000_red", "SR_m_a2015_red"))
gc()
...
SR_forest_ebba1 <- SR(forest_ebba1)
hist(SR_forest_ebba1$SR)
write_csv(SR_forest_ebba1, "own datasets/SR_forest_ebba1_50km_change.csv")

SR_agriculture_ebba1 <- SR(agriculture_ebba1)
hist(SR_agriculture_ebba1$SR)
write_csv(SR_agriculture_ebba1, "own datasets/SR_agriculture_ebba1_50km_change.csv")

SR_generalist_ebba1 <- SR(generalist_ebba1)
hist(SR_generalist_ebba1$SR)
write_csv(SR_generalist_ebba1, "own datasets/SR_generalist_ebba1_50km_change.csv")


SR_forest_ebba2 <- SR(forest_ebba2)
hist(SR_forest_ebba2$SR)
write_csv(SR_forest_ebba2, "own datasets/SR_forest_ebba2_50km_change.csv")

SR_agriculture_ebba2 <- SR(agriculture_ebba2)
hist(SR_agriculture_ebba2$SR)
write_csv(SR_agriculture_ebba2, "own datasets/SR_agriculture_ebba2_50km_change.csv")

SR_generalist_ebba2 <- SR(generalist_ebba2)
hist(SR_generalist_ebba2$SR)
write_csv(SR_generalist_ebba2, "own datasets/SR_generalist_ebba2_50km_change.csv")
...
plot
ggsave("plots/species richness/SR_birds_forest_ebba1_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_agriculture_ebba1)
plot
ggsave("plots/species richness/SR_birds_agriculture_ebba1_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_generalist_ebba1)
plot
ggsave("plots/species richness/SR_birds_generalist_ebba1_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


# EBBA2
plot <- plot_SR(SR_forest_ebba2)
plot
ggsave("plots/species richness/SR_birds_forest_ebba2_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_agriculture_ebba2)
plot
ggsave("plots/species richness/SR_birds_agriculture_ebba2_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_generalist_ebba2)
plot
ggsave("plots/species richness/SR_birds_generalist_ebba2_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


hist_SR <- function(df) {
  png(paste("plots/species richness/hist_", paste(deparse(substitute(df))), ".png", sep = ""),
    width = 800,
    height = 600,
    res = 100
  )
...
# before 2000
SR_forest_m_b2000 <- SR(forest_m_b2000)
hist(SR_forest_m_b2000$SR, breaks = 50, col = "lightblue", main = "")
write_csv(SR_forest_m_b2000, "own datasets/SR_forest_m_b2000_50km.csv")

SR_agriculture_m_b2000 <- SR(agriculture_m_b2000)
hist(SR_agriculture_m_b2000$SR, breaks = 50, col = "lightblue", main = "")
write_csv(SR_agriculture_m_b2000, "own datasets/SR_agriculture_m_b2000_50km.csv")

SR_generalist_m_b2000 <- SR(generalist_m_b2000)
hist(SR_generalist_m_b2000$SR, breaks = 50, col = "lightblue", main = "")
write_csv(SR_generalist_m_b2000, "own datasets/SR_generalist_m_b2000_50km.csv")


# after 2015
SR_forest_m_a2015 <- SR(forest_m_a2015)
hist(SR_forest_m_a2015$SR, breaks = 50, col = "lightblue", main = "")
write_csv(SR_forest_m_a2015, "own datasets/SR_forest_m_a2015_50km.csv")

SR_agriculture_m_a2015 <- SR(agriculture_m_a2015)
hist(SR_agriculture_m_a2015$SR, breaks = 50, col = "lightblue", main = "")
write_csv(SR_agriculture_m_a2015, "own datasets/SR_agriculture_m_a2015_50km.csv")

SR_generalist_m_a2015 <- SR(generalist_m_a2015)
hist(SR_generalist_m_a2015$SR, breaks = 50, col = "lightblue", main = "")
write_csv(SR_generalist_m_a2015, "own datasets/SR_generalist_m_a2015_50km.csv")


# before 2000
plot <- plot_SR(SR_forest_m_b2000)
plot
ggsave("plots/species richness/SR_mammals_forest_b2000.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_agriculture_m_b2000)
plot
ggsave("plots/species richness/SR_mammals_agriculture_b2000.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_generalist_m_b2000)
plot
ggsave("plots/species richness/SR_mammals_generalist_b2000.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


# after 2015
plot <- plot_SR(SR_forest_m_a2015)
plot
ggsave("plots/species richness/SR_mammals_forest_a2015.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_agriculture_m_a2015)
plot
ggsave("plots/species richness/SR_mammals_agriculture_a2015.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_generalist_m_a2015)
plot
ggsave("plots/species richness/SR_mammals_generalist_a2015.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot
ggsave("plots/species richness/deltaSR_bird_forest.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR(deltaSR_bird_agriculture)
plot
ggsave("plots/species richness/deltaSR_bird_agriculture.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR(deltaSR_bird_generalist)
plot
ggsave("plots/species richness/deltaSR_bird_generalist.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_deltaSR(deltaSR_mammal_forest)
plot
ggsave("plots/species richness/deltaSR_mammal_forest.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR(deltaSR_mammal_agriculture)
plot
ggsave("plots/species richness/deltaSR_mammal_agriculture.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR(deltaSR_mammal_generalist)
plot
ggsave("plots/species richness/deltaSR_mammal_generalist.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot_deltaSR_fixed <- function(df, spect_ref) {
  ...
  plot <- ggplot(grid_SR_forest_ebba1) +
    ...
    scale_fill_viridis_c(
      na.value = "grey", option = "C",
      limits = c(
        min(spect_ref, na.rm = TRUE),
        max(spect_ref, na.rm = TRUE)
      )
    ) +
    theme_minimal() +
    labs(
      title = paste(deparse(substitute(df)), "_fixed_spect", sep = ""),
      fill = "delta SR"
    )
  plot
  return(plot)
...
plot
ggsave("plots/species richness/deltaSR_bird_forest_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR_fixed(deltaSR_bird_agriculture, deltaSR_bird_generalist$delta_SR)
plot
ggsave("plots/species richness/deltaSR_bird_agriculture_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR_fixed(deltaSR_bird_generalist, deltaSR_bird_generalist$delta_SR)
plot
ggsave("plots/species richness/deltaSR_bird_generalist_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


plot <- plot_deltaSR_fixed(deltaSR_mammal_forest, deltaSR_mammal_generalist$delta_SR)
plot
ggsave("plots/species richness/deltaSR_mammal_forest_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR_fixed(deltaSR_mammal_agriculture, deltaSR_mammal_generalist$delta_SR)
plot
ggsave("plots/species richness/deltaSR_mammal_agriculture_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
plot <- plot_deltaSR_fixed(deltaSR_mammal_generalist, deltaSR_mammal_generalist$delta_SR)
plot
ggsave("plots/species richness/deltaSR_mammal_generalist_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
write_csv(merged_df, "own datasets/SR_classes_FAG.csv")


rm(list = c(
  "forest_ebba1", "forest_ebba2",
  "agriculture_ebba1", "agriculture_ebba2",
  "generalist_ebba1", "generalist_ebba2",
  "forest_ebba1_dt",
  "agriculture_ebba1_dt",
  "generalist_ebba1_dt",
  "forest_ebba1", "forest_ebba2",
  "agriculture_ebba1", "agriculture_ebba2",
  "generalist_ebba1", "generalist_ebba2",
  "forest_m_b2000", "forest_m_a2015",
  "agriculture_m_b2000", "agriculture_m_a2015",
  "generalist_m_b2000", "generalist_m_a2015",
  "forest_m_b2000", "forest_m_a2015",
  "agriculture_m_b2000", "agriculture_m_a2015",
  "generalist_m_b2000", "generalist_m_a2015"
))
...
SR_natural_ebba1 <- SR(natural_ebba1)
hist(SR_natural_ebba1$SR)
write_csv(SR_natural_ebba1, "own datasets/SR_natural_ebba1_50km_change.csv")

SR_human_dominated_ebba1 <- SR(human_dominated_ebba1)
hist(SR_human_dominated_ebba1$SR)
write_csv(SR_human_dominated_ebba1, "own datasets/SR_human_dominated_ebba1_50km_change.csv")


# EBBA2 #

SR_natural_ebba2 <- SR(natural_ebba2)
hist(SR_natural_ebba2$SR)
write_csv(SR_natural_ebba2, "own datasets/SR_natural_ebba2_50km_change.csv")

SR_human_dominated_ebba2 <- SR(human_dominated_ebba2)
hist(SR_human_dominated_ebba2$SR)
write_csv(SR_human_dominated_ebba2, "own datasets/SR_human_dominated_ebba2_50km_change.csv")
...
plot
ggsave("plots/species richness/SR_birds_natural_ebba1_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_human_dominated_ebba1)
plot
ggsave("plots/species richness/SR_birds_human_dominated_ebba1_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


# EBBA2
plot <- plot_SR(SR_natural_ebba2)
plot
ggsave("plots/species richness/SR_birds_natural_ebba2_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_human_dominated_ebba2)
plot
ggsave("plots/species richness/SR_birds_human_dominated_ebba2_change.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
# before 2000
SR_natural_m_b2000 <- SR(natural_m_b2000)
hist(SR_natural_m_b2000$SR)
write_csv(SR_natural_m_b2000, "own datasets/SR_natural_m_b2000_50km.csv")

SR_human_dominated_m_b2000 <- SR(human_dominated_m_b2000)
hist(SR_human_dominated_m_b2000$SR)
write_csv(SR_human_dominated_m_b2000, "own datasets/SR_human_dominated_m_b2000_50km.csv")


# after 2015
SR_natural_m_a2015 <- SR(natural_m_a2015)
hist(SR_natural_m_a2015$SR)
write_csv(SR_natural_m_a2015, "own datasets/SR_natural_m_a2015_50km.csv")

SR_human_dominated_m_a2015 <- SR(human_dominated_m_a2015)
hist(SR_human_dominated_m_a2015$SR)
write_csv(SR_human_dominated_m_a2015, "own datasets/SR_human_dominated_m_a2015_50km.csv")
...
plot
ggsave("plots/species richness/SR_birds_natural_m_b2000.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_human_dominated_m_b2000)
plot
ggsave("plots/species richness/SR_birds_human_dominated_m_b2000.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


# after 2015
plot <- plot_SR(SR_natural_m_a2015)
plot
ggsave("plots/species richness/SR_birds_natural_m_a2015.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_SR(SR_human_dominated_m_a2015)
plot
ggsave("plots/species richness/SR_birds_human_dominated_m_a2015.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot
ggsave("plots/species richness/deltaSR_bird_natural.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_deltaSR(deltaSR_bird_human_dominated)
plot
ggsave("plots/species richness/deltaSR_bird_human_dominated.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


plot <- plot_deltaSR(deltaSR_mammal_natural)
plot
ggsave("plots/species richness/deltaSR_mammal_natural.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_deltaSR(deltaSR_mammal_human_dominated)
plot
ggsave("plots/species richness/deltaSR_mammal_human_dominated.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot
ggsave("plots/species richness/deltaSR_bird_natural_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_deltaSR_fixed(deltaSR_bird_human_dominated, deltaSR_bird_human_dominated$delta_SR)
plot
ggsave("plots/species richness/deltaSR_bird_human_dominated_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")


plot <- plot_deltaSR_fixed(deltaSR_mammal_natural, deltaSR_mammal_human_dominated$delta_SR)
plot
ggsave("plots/species richness/deltaSR_mammal_natural_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")

plot <- plot_deltaSR_fixed(deltaSR_mammal_human_dominated, deltaSR_mammal_human_dominated$delta_SR)
plot
ggsave("plots/species richness/deltaSR_mammal_human_dominated_fixed_spec.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
write_csv(merged_df, "own datasets/SR_classes_NHD.csv")


rm(list = c(
  "m_b2000", "m_a2015",
  "ebba1", "ebba2",
  "natural_ebba1", "natural_ebba2",
  "human_dominated_ebba1", "human_dominated_ebba2",
  "natural_m_b2000", "natural_m_a2015",
  "human_dominated_m_b2000", "human_dominated_m_a2015",
  "natural_ebba1_dt", "natural_ebba2",
  "human_dominated_ebba1_dt", "human_dominated_ebba2",
  "natural_m_b2000", "natural_m_a2015",
  "human_dominated_m_b2000", "human_dominated_m_a2015"
))
gc()
...
deltaSR_birds_50km <- read_csv("own datasets/deltaSR_birds_50km.csv") # 'whole' EBBA data set
deltaSR_mammals_50km <- read_csv("own datasets/deltaSR_mammals_50km.csv")
deltaT_50km <- read_csv("own datasets/deltaT_50km_20y.csv")
ccv_50km <- read_csv("own datasets/ccv_50km_20y.csv")
...
write_csv(merged_df, "own datasets/analysis_data_50km_full.csv")
...
# ___________________________________________________________________________
# Histograms ####
data_change <- read_csv("own datasets/analysis_data_50km_change.csv")
data_full <- read_csv("own datasets/analysis_data_50km_full.csv")


# Number of occurrences mammals
png("plots/occurrence frequency/hist_Occ_mammals_b2000.png",
  width = 800,
  height = 600,
  res = 100
)
...
png("plots/occurrence frequency/hist_Occ_mammals_a2015.png",
  width = 800,
  height = 600,
  res = 100
)
...
hist(data_change$SR_ebba1,
  breaks = 50,
  col = "lightblue",
  main = "Distr. of Species Richness in EBBA1 Birds (50km)"
)
abline(v = mean(data_change$SR_ebba1, na.rm = TRUE), col = "red", lwd = 2, lty = 2)
abline(v = median(data_change$SR_ebba1, na.rm = TRUE), col = "blue", lwd = 2, lty = 3)
legend("topright",
  legend = c("Mean", "Median"),
  col = c("red", "blue"),
  lty = c(2, 3),
...
hist(data_change$SR_ebba2,
  breaks = 50,
  col = "lightblue",
  main = "Distr. of Species Richness in EBBA2 Birds (50km)"
)
abline(v = mean(data_change$SR_ebba2, na.rm = TRUE), col = "red", lwd = 2, lty = 2)
abline(v = median(data_change$SR_ebba2, na.rm = TRUE), col = "blue", lwd = 2, lty = 3)
legend("topright",
  legend = c("Mean", "Median"),
  col = c("red", "blue"),
  lty = c(2, 3),
...
hist(data_change$deltaSR_birds,
  breaks = 50,
  col = "lightblue",
  main = "Distr. of Species Richness Change in EBBA Birds (50km)"
)
abline(v = mean(data_change$deltaSR_birds, na.rm = TRUE), col = "red", lwd = 2, lty = 2)
abline(v = median(data_change$deltaSR_birds, na.rm = TRUE), col = "blue", lwd = 2, lty = 3)
legend("topright",
  legend = c("Mean", "Median"),
  col = c("red", "blue"),
  lty = c(2, 3),
...
# delta temperature
png("plots/temperature/hist_delta_temperature.png",
  width = 800,
  height = 600,
  res = 100
)
...
png("plots/temperature/hist_climate_change_velocity.png",
  width = 800,
  height = 600,
  res = 100
)
...
png("plots/temperature/hist_log_climate_change_velocity.png",
  width = 800,
  height = 600,
  res = 100
)
...
plot <- ggplot(data_change, aes(x = log_ccv, y = deltaSR_birds)) +
  ...
  geom_smooth(method = "glm", se = TRUE) +
  labs(
    x = "Log Climate Change Velocity (logCCV)",
    y = "Species Richness Change (ΔSR)"
  ) +
  theme_minimal() +
  theme(
...
write_csv(coefficients_df, "own datasets/temperature_coefficients_EBBA_change.csv")
...
ggsave("plots/models/regline_SR_mammals_birds~deltaT.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
ggsave("plots/models/regline_SR_mammals_birds~logCCV.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
plot_deltaSR_test <- function(df) {
  # First join your data to the full grid
  plot_df <- grid_50km %>%
    left_join(df, by = "cell50x50") %>%
    # Mark if cell is in grid_50km_change or not
    mutate(
      in_change_grid = ifelse(cell50x50 %in% grid_50km_change$cell50x50, TRUE, FALSE)
    ) %>%
    mutate(
      delta_SR_cat = dplyr::case_when(
        in_change_grid == FALSE ~ "no_change_grid", # cells NOT in grid_50km_change -> grey
        is.na(delta_SR) ~ NA_character_, # data missing -> grey as well
        delta_SR == 0 ~ "zero",
        delta_SR < -14 ~ "darkorange",
        delta_SR >= -14 & delta_SR <= -1 ~ "lightorange",
        delta_SR > 0 & delta_SR <= 14 ~ "lightblue",
        delta_SR > 14 ~ "darkblue"
      ),
      delta_SR_cat = factor(delta_SR_cat, levels = c("darkorange", "lightorange", "zero", "lightblue", "darkblue", "no_change_grid"))
    )

  # Your colors, including grey for cells outside the change grid
  cat_colors <- c(
    "zero" = "white",
    "lightorange" = "#F39C12",
    "darkorange" = "#D35400",
    "lightblue" = "#5DADE2",
    "darkblue" = "#154360",
    "no_change_grid" = "grey80"
  )

  plot <- ggplot(plot_df) +
    geom_sf(aes(fill = delta_SR_cat), color = "black", size = 0.1) +
    scale_fill_manual(
      values = cat_colors,
      na.value = "grey50", # for any other NAs (should be rare here)
      drop = FALSE,
      na.translate = TRUE
    ) +
    theme_minimal() +
...
plot_df <- read_csv("own datasets/deltaSR_birds_50km_change.csv")

grid_50km <- st_read("external datasets/EBBA/ebba2_grid50x50_v1/ebba2_grid50x50_v1_EditNoIslandsNoEast.shp")
grid_50km_change <- st_read("external datasets/EBBA/ebba2_grid50x50_v1/ebba_grid50x50_change_selfmade_NoIslandsNoEast.shp")

plot_deltaSR_test(plot_df)
