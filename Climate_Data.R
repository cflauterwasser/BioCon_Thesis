...
tifs_80_00_tmin = list.files(path = "external datasets/WorldClim/1. Historical/20y avg (1990-2012)/tmin 1980-2000",
                             pattern = "\\.tif$",
                             full.names = TRUE)

tifs_80_00_tmax = list.files(path = "external datasets/WorldClim/1. Historical/20y avg (1990-2012)/tmax 1980-2000",
                             pattern = "\\.tif$",
                             full.names = TRUE)
...
tifs_02_22_tmin = list.files(path = "external datasets/WorldClim/1. Historical/20y avg (1990-2012)/tmin 2002-2022",
                             pattern = "\\.tif$",
                             full.names = TRUE)

tifs_02_22_tmax = list.files(path = "external datasets/WorldClim/1. Historical/20y avg (1990-2012)/tmax 2002-2022",
                             pattern = "\\.tif$",
                             full.names = TRUE)
...
# in absence of true tavg data, simplified assumption that mean temperature is exactly between tmin and tmax
...
png("plots/deltaT_2.5min_20y.png",
    width = 800,
    height = 600,
    res = 100)
...
write.csv(st_drop_geometry(grid_50km_sf), "own datasets/deltaT_50km_20y.csv", row.names = FALSE)
...
ggsave("plots/deltaT_50km_20y.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
write.csv(st_drop_geometry(grid_50km_sf), "own datasets/ccv_50km_20y.csv", row.names = FALSE)
#write.csv(st_drop_geometry(grid_50km_sf), "own datasets/ccv_50km_noEast.csv", row.names = FALSE)
...
ggsave("plots/ccv_50km_20y.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
ggsave("plots/log_ccv_50km_20y.png", plot = plot, width = 10, height = 8, dpi = 300, bg = "white")
...
ccv_50km_20y = read.csv("own datasets/ccv_50km_20y.csv")
deltaT_50km_20y = read.csv("own datasets/deltaT_50km_20y.csv")

# delta temperature
png("plots/hist_delta_temperature_20y.png",
    width = 800,
    height = 600,
    res = 100)
...
png("plots/hist_climate_change_velocity_20y.png",
    width = 800,
    height = 600,
    res = 100)
...
png("plots/hist_log_climate_change_velocity_20y.png",
    width = 800,
    height = 600,
    res = 100)
